...
% Creates imdb file and train NN for detection
...
opts.train.expDir = [vl_rootnn '/data/nuclei'];
opts.dataDir = [vl_rootnn '/data/nuclei-dataset'] ;
...
figure(4) ; vl_tshow(net.layers{3}.weights{1}) ; title('Conv2 filters, layer 3');
figure(5) ; vl_tshow(net.layers{5}.weights{1}) ; title('Conv3 filters, layer 5');
...
% Preallocate memory
totalSamples = 6600 ;  % 3000 * 2 + 300 * 2
